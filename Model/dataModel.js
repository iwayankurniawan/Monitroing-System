...
//---------------clicked for history features---------------------------
    $('.search').on('click', function(e){
      ...
      $('#mindate').val(searchHistoryList[e.target.id].minDate.toISOString().substring(0, 19));
      $('#maxDate').val(searchHistoryList[e.target.id].maxDate.toISOString().substring(0, 19));
...
function backClicked(){
  ...
  $('#mindate').val(searchHistoryList[historyPosition].minDate.toISOString().substring(0, 19));
  $('#maxDate').val(searchHistoryList[historyPosition].maxDate.toISOString().substring(0, 19));
  //BUILD THE MONITORING SYSTEM
